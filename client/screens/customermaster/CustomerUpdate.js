...
import { adminCustomerGetSingleAxios,adminCustomerPutAxios } from "../../axios/admin";
  ...
  useEffect(async() => {
	...
	return (
      ...
      initialValues={{
        ...
        building_name: customer[0]['customer_address'].building_name,
        ...
        pincode: customer[0]['customer_address'].pincode.toLocaleString(),
        state: customer[0]['customer_address'].state,
        country: customer[0]['customer_address'].country,
        email: customer[0]['customer'].email,
        phone_number: customer[0]['customer'].phone.toLocaleString(),
        gst_no: customer[0]['customer'].gst_no.toLocaleString(),
        fax_no: customer[0]['customer'].fax_no.toLocaleString(),
        shipping_building_name: customer[0]['shipping_address'].building_name,
        shipping_street_1: customer[0]['shipping_address'].street_1,
        shipping_street_2: customer[0]['shipping_address'].street_2,
        shipping_locality: customer[0]['shipping_address'].locality,

        shipping_district: customer[0]['shipping_address'].district,
        shipping_pincode: customer[0]['shipping_address'].pincode.toLocaleString(),
        shipping_state: customer[0]['shipping_address'].state,
        shipping_country: customer[0]['shipping_address'].country,
        ...
        a_c_phone_number: customer[0]['ac'].mobile_number.toLocaleString(),
        ...
        stores_phone_number: customer[0]['stores'].mobile_number.toLocaleString(),
        purchase_name: customer[0]['purchase'].person_name,
        purchase_designation: customer[0]['purchase'].designation,
        purchase_department: customer[0]['purchase'].department,
        purchase_email: customer[0]['purchase'].email,
        purchase_phone_number: customer[0]['purchase'].mobile_number.toLocaleString(),
        ...
        manager_phone_number: customer[0]['manager'].mobile_number.toLocaleString()
      }}
          ...
          <View style={styles.main}>
            <>
              {arr.map((item, index) => {
                ...
                return (
                  <Fragment key={index}>
                    <Text style={styles.maintitle}>{item.catagoryname}</Text>
                        ...
                        <View style={styles.container}>
                          ...
                          <TextInput
                            ...
                            keyboardType={
                              field.name == "gst_no"
                                ? "numeric"
                                : "default" && field.name == "phone_number"
                                ? "numeric"
                                : "default" && field.name == "fax_no"
                                ? "numeric"
                                : "default" && field.name == "pincode"
                                ? "numeric"
                                : "default" && field.name == "shipping_pincode"
                                ? "numeric"
                                : "default" && field.name == "a_c_phone_number"
                                ? "numeric"
                                : "default" &&
                                  field.name == "stores_phone_number"
                                ? "numeric"
                                : "default" &&
                                  field.name == "purchase_phone_number"
                                ? "numeric"
                                : "default" &&
